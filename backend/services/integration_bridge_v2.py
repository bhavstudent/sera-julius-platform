...
try:
    ...
    print(f"?? Causal Functor import error: {e}")
...
class JuliusIntegrationBridge:
    ...
    def _init_causal(self):
        ...
        if CAUSAL_AVAILABLE:
            try:
                ...
                print(f"  ?? CausalGraph init error: {e}")
    ...
    def _init_kronos(self):
        ...
        if KRONOS_AVAILABLE and self.model is not None:
            ...
            print("  ?? KRONOS waiting for model (call set_model())")
