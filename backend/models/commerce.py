"""
Commerce Models - Simplified
============================
SQLAlchemy models for companies and financial data.
"""
...
# Placeholder for other models - add if needed
...
class HealthcareMetric(Base):
    ...
    avg_total_payment = Column(Float, default=0.0)
