...
REDIS_HOST = getattr(_config_instance, 'REDIS_HOST', os.getenv('REDIS_HOST', 'localhost'))
REDIS_PORT = getattr(_config_instance, 'REDIS_PORT', int(os.getenv('REDIS_PORT', '6379')))
REDIS_PASSWORD = getattr(_config_instance, 'REDIS_PASSWORD', os.getenv('REDIS_PASSWORD', ''))
REDIS_DB = getattr(_config_instance, 'REDIS_DB', int(os.getenv('REDIS_DB', '0')))
