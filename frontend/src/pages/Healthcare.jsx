  ...
  return (
    <div style={{ animation: 'fadeUp 0.4s ease', display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px' }}>
        <GlassCard title="Total Hospitalizations" glowType="red">
          <div style={{ padding: '15px 0' }}>
            <div className="mono" style={{ fontSize: '28px', color: '#ff2a20', fontWeight: 'bold' }}>
              {formatNumber(stats.totalAdmissions)}
            </div>
            <div style={{ fontSize: '11px', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '1px', marginTop: '4px' }}>
              Aggregate NFHS-5 Records
            </div>
          </div>
        </GlassCard>

        <GlassCard title="Average Admission Rate" glowType="red">
          <div style={{ padding: '15px 0' }}>
            <div className="mono" style={{ fontSize: '28px', color: '#ff5e3a', fontWeight: 'bold' }}>
        ...
        <GlassCard title="Anomalous Threshold (2 SD)" glowType="red">
          <div style={{ padding: '15px 0' }}>
            <div className="mono" style={{ fontSize: '28px', color: '#ff003c', fontWeight: 'bold' }}>
